    ...
    switch (section) {
      case AdminDashboardSection.listings:
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, i) => AdminListingApprovalCard(listing: listings[i]),
        );
      ...
      case AdminDashboardSection.payments:
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, i) => AdminPaymentConfirmationCard(payment: payments[i]),
        );
      ...
      case AdminDashboardSection.transactionLog:
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, i) => AdminTransactionLogEntryCard(entry: sorted[i]),
        );
    }
  }
}
