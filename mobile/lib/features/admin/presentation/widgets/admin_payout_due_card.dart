    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Expanded(child: Text('Host: ${payout.hostName}', style: AppTextStyles.titleMedium)),
              Text('ETB ${payout.hostShare.toStringAsFixed(2)}', style: AppTextStyles.price),
            ],
          ),
          ...
          if (isDue)
            ...
            Row(
              ...
              children: const [
                Icon(Icons.check_circle, size: 16, color: AppColors.statusConfirmed),
                SizedBox(width: 4),
          ...
          if (isDue) ...[
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: _codeController.text.trim().isEmpty
                    ? null
                    : () {
                        ref.read(adminActionsCoordinatorProvider).markPayoutPaid(
                              payoutId: payout.id,
            ...
            Text('Paid with code: ${payout.transactionCode}', style: AppTextStyles.bodySmall),
          ],
        ],
      ),
    );
