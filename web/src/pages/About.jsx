      ...
      <section className="py-4 px-6 max-w-[900px] mx-auto">
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-8 md:p-10">
          ...
          <p className="text-[14px] text-gray-500 leading-relaxed">
            We measure success by how easily a host can turn a spare room into income, and how confidently a guest can book a stay they've never seen in person.
          </p>
        </div>
      </section>
        ...
        <div className="bg-white rounded-3xl border border-gray-100 overflow-hidden shadow-lg grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="p-8 md:p-10 flex flex-col justify-center">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link to="/become-a-host" className="px-6 py-3 rounded-xl text-[14px] font-bold border border-gray-200 hover:border-gray-300 text-gray-700 transition-colors">
                Become a host
              </Link>
            </div>
          </div>
