    ...
    <AuthLayout>
      ...
      <div className="mb-6">
        ...
        <p className="m-0 text-gray-500 text-[14px]">
          {location.state?.from ? "Log in to continue listing your place." : "Log in to manage your trips and saved stays."}
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          <div className="flex justify-between items-center mb-1.5">
            ...
            <button type="button" className="text-primary text-[13px] font-medium hover:underline">
              Forgot password?
            </button>
          </div>
          <Input 
        ...
        <p className="text-center text-gray-500 text-[14px]">
          New to Ethio Stays?{" "}
          <Link to="/register" state={{ from: redirectPath }} className="text-primary font-semibold hover:underline">
            Create account
          </Link>
        </p>
      </form>
